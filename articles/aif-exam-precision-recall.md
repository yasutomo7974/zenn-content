...
サービスの見分け(SageMaker、Comprehendなど)、推論パラメータ(Top-K、Max Tokens)、責任あるAI(Explainabilityなど)は、繰り返し練習した甲斐もあって安定して正解できるようになってきました。一方でPrecision/Recallのような「似た概念のどちらが問われているか」を見分けるパターンは、まだ油断すると間違えます。ここは本番前にもう一度重点的に潰しておこうと思います。
